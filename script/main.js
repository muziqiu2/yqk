...
const App = new Vue({
  ...
  data: {
    ...
    chatRoom: null,
    appId: 'GSjtRccke94oHW2Uz9UUYkLC-gzGzoHsz',
    appKey: 'nKpTAzEDURA6QynGFnMpma50',
    server: 'https://gsjtrcck.lc-cn-n1-shared.com', // REST API 服务器地址
  },
  methods: {
    randomString(length) {
      let str = ''
  ...
  mounted() {
    ...
    /*使用socket-io*/
    // this.socket = io('http://101.43.242.202:2233'); // 替换成你的websocket服务地址
